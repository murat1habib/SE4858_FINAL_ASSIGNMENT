        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelId = table.Column<string>(type: "nvarchar(64)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availability_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availability_HotelId_Date_RoomType",
                table: "Availability",
                columns: new[] { "HotelId", "Date", "RoomType" });
        }
